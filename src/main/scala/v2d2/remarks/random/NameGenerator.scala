package remarks.random

import scala.util.Random

object NameGen {
  val adj: List[String] = List(
    "admiring",
    "adoring",
    "agitated",
    "amazing",
  ...
  // I stole this from docker and would like to follow their guide lines 
  // Docker, starting from 0.7.x, generates names from notable scientists and hackers.
  // Please, for any amazing man that you add to the list, consider adding an equally amazing woman to it, and vice versa.
  val noun: List[String] = List(
  ...
  def getRandomName(): String = {
    val start = Random.shuffle(adj).head
    val end = Random.shuffle(noun).head
    return s"${start} ${end}"
  }
